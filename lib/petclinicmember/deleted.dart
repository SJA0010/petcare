...
class PetClinicsNumbers4 extends StatefulWidget {
  const PetClinicsNumbers4({super.key});
//make by Subhan Abbasi 6
  @override
  State<PetClinicsNumbers4> createState() => _PetClinicsNumbers4State();
}

class _PetClinicsNumbers4State extends State<PetClinicsNumbers4> {
  var width, height;
  @override
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: const Text(
                                              ...
                                              "Are You Sure You Want to Delete the name of this document?",
                                              style: TextStyle(
                                                  fontSize: 18,
                                                  color: Colors.black),
                                            ),
