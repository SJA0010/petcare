...
//make by Subhan Abbasi 1923
class Calendar3 extends StatefulWidget {
  const Calendar3({super.key});

  @override
  State<Calendar3> createState() => _Calendar3State();
}
...
class _Calendar3State extends State<Calendar3> {
  ...
  Widget build(BuildContext context) {
    ...
    Future.delayed(const Duration(seconds: 2), () {
      Apptheme.alert(
          context, "Are you sure that you want to delete? ", height, width);
    });
    return Scaffold(
      body: Container(
        color: Colors.white,
