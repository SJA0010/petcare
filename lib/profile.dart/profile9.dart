              ...
              children: [
                ...
                Align(
                  ...
                  child: Apptheme.button(
                      "Done", height, width, Icons.download_done_sharp,
                      color: Apptheme.pinkcolor),
                ),
                SizedBox(height: height * 0.02),
              ],
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        Apptheme.smalltext("Password",
            textColor: const Color.fromRGBO(158, 158, 158, 1)),
        Apptheme.smalltext(
            "password should be have 8 character ,upper ,and lowercase latter",
            fontSize: 10.0,
            textColor: Colors.red),
        Row(
          children: [
