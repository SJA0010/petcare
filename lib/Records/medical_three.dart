...
class Medicalthree extends StatefulWidget {
  const Medicalthree({super.key});
  @override
  State<Medicalthree> createState() => _MedicalthreeState();
}

class _MedicalthreeState extends State<Medicalthree> {
  var width, height;
  @override
