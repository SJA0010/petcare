...
class Medicaltwo extends StatefulWidget {
  const Medicaltwo({super.key});
  @override
  State<Medicaltwo> createState() => _MedicaltwoState();
}

class _MedicaltwoState extends State<Medicaltwo> {
  var width, height;
  @override
